...
const { getRandomIntInclusive, logger } = require('../../util/helper');
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    for (i = 0; i < numNotes; i++) {
      const randomNote = scale.notes[getRandomIntInclusive(0, scale.notes.length - 1)];
      const randomDuration = durations[getRandomIntInclusive(0, durations.length - 1)];
      track.addEvent(
